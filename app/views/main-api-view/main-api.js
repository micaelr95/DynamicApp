                ...
                for (index = 0; index < mainApi.length; index++) {
                    ...
                    switch (mainApi[index].Type) {
                        case "button":
                            ...
                            absoluteLayout.AbsoluteLayout.setLeft(button, mainApi[index].Left);
                            absoluteLayout.AbsoluteLayout.setTop(button, mainApi[index].Top);
                            layoutType.addChild(button);
                            break;
                    }
                }
                ...
                for (index = 0; index < mainApi.length; index++) {
                    ...
                    switch (mainApi[index].Type) {
                        case "button":
                            ...
                            wrapLayout.orientation = MainApiLayout.Orientation;
                            layoutType.addChild(button);
                            break;
                    }
                }
